...
routing_file=$(curl -s "https://github.com/mmdzov/auto-conf-marzban/raw/main/routing.json" | jq -c '.')
outbounds_file=$(curl -s "https://github.com/mmdzov/auto-conf-marzban/raw/main/outbounds.json" | jq -c '.')
